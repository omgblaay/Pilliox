import svgPaths from "./svg-hepzwgk5tt";
...
function Vector() {
  return (
    <div className="h-[40px] relative shrink-0 w-[137px]" data-name="Vector">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 137 40">
        <g id="Vector">
          <g id="Vector_2">
            <path d={svgPaths.p3a75c800} fill="#6D6D6D" />
            <path d={svgPaths.p1e673f00} fill="var(--fill-0, white)" />
            <path d={svgPaths.p180f2cf0} fill="var(--fill-0, white)" />
            <path d={svgPaths.p1bb320f0} fill="var(--fill-0, white)" />
            <path d={svgPaths.p28f48800} fill="var(--fill-0, white)" />
            <path d={svgPaths.p191229f0} fill="var(--fill-0, white)" />
            <path d={svgPaths.p32a77200} fill="var(--fill-0, white)" />
            <path d={svgPaths.pf7e9600} fill="var(--fill-0, white)" />
            <path d={svgPaths.p2c88e200} fill="var(--fill-0, white)" />
          </g>
        </g>
      </svg>
    </div>
