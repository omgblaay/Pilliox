export default {
  ...
  calendar: {
    ...
    editOtherMedication: "Medikament bearbeiten",
    editOtherMedicationDesc: "Aktualisieren Sie die Medikamentendetails.",
  ...
  medications: {
    ...
    empty: {
      ...
      description: "Fügen Sie Ihr erstes Medikament hinzu, um Ihre Dosierungen zu verfolgen",
    },
    addFirst: "Erstes Medikament hinzufügen",
  },
  common: {
    loading: "Laden...",
    saving: "Speichern...",
  ...
  pillsSettings: {
    ...
    description:
      "Konfigurieren Sie Ihre Medikamente und Standarddosierungen",
    ...
    cancel: "Abbrechen",
    loadError:
      "Medikamenten-Einstellungen konnten nicht geladen werden",
    saveSuccess:
      "Medikamenten-Einstellungen erfolgreich gespeichert",
    saveError:
    ...
    bannerTitle: "Benachrichtigungen aktivieren",
    bannerDescription: "Erhalten Sie Erinnerungen für Ihre Medikamente und medizinischen Werte",
    enableButton: "Benachrichtigungen aktivieren",
    notNow: "Nicht jetzt",
    requesting: "Wird angefordert...",
    testTitle: "Benachrichtigungen testen",
    testDescription: "Senden Sie eine Testbenachrichtigung, um zu überprüfen, ob sie funktionieren",
    testButton: "Test senden",
    sending: "Wird gesendet...",
    testSent: "Testbenachrichtigung gesendet!",
    testFailed: "Fehler beim Senden der Testbenachrichtigung",
